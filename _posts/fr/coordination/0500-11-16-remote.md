...
Cette page de LearnOSM est en cours de traduction. Si vous voulez participer à la traduction de cette page, rejoignez-nous sur Hackpad dans le document collaboratif [LearnOSM FR remote](https://hackpad.com/B9P2eceMcbh). Si vous voulez aider pour d'autres pages, rendez-vous sur  [CONTRIBUTING.md](https://github.com/hotosm/learnosm/blob/gh-pages/CONTRIBUTING.md).
