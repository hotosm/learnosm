...
**Tag** (Attribut): Les attributs décrivent un point, une ligne ou un polygone. Chaque attribut contient une clé et une valeur (écrite en OSM comme 'key=value'). Par exemple, highway=residential et name=Woodland Avenue. Mentionné au début dans Learnosm dans la [section iD](/fr/beginner/id-editor/#basic-editor/#basic-editing-with-id). Un point, une ligne ou un polygone ont généralement plusieurs attributs associés à chacun d'eux. Parfois, le choix du bon attribut est compliqué. [Taginfo](https://taginfo.openstreetmap.org/) vous aide en affichant des statistiques sur les attributs qui sont réellement dans la base de données, combien de personnes utilisent ces attributs, où ils sont utilisés et ainsi de suite. Taginfo recueille également des informations sur les attributs à partir du wiki et d'autres endroits.
