...
- Open QGIS en klik op de knop "PostGIS-klaag toevoegen". ![qgis add postgis button][]{: height="24px"}
...
- Als alles goed is gegaan zult u de door u geslecteerde lagen in QGIS zien weergegeven.  
...
Een andere gereedschap voor importeren dat recent is ontwikkeld, is genaamd [imposm](http://imposm.org/), en biedt enkele verbeteringen op het gebied van snelheid en andere boven osm2pgsql, hoewel het op jet moment van schrijven andere sleutelfuncties ontbeert, die werden beloofd in imposm versie 3.  
