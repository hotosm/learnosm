...
Per usare il Tasking Manager di HOT devi registrarti su OpenStreetMap (OSM) con un nome utente ed una password. Per ulteriori istruzioni leggi il [Tutorial Tasking Manager](http://learnosm.org/it/coordination/tm-user/).  
...
[HOT Activities](https://www.hotosm.org/what-we-do) - descrive dal loro sito le attività HOT in maggior dettaglio  