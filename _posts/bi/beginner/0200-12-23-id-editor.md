...
> Caution, this guide is not completely up to date. The latest version is only available in [English](/en/beginner/id-editor/). To help produce translations for this site, go to <https://www.transifex.com> and search for **HOT-OSM**.  
