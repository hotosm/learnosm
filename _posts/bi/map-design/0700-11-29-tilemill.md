...
Perhatika elemen kunci pada TileMill:
...
*	Pada tab layer carilah layer baru Anda dan klik tombol "Zomm to extent"	
...
Jika Anda memiliki akun MapBox (apa yang kita buat di [bab sebelumnya](/en/map-design/mapbox)),
