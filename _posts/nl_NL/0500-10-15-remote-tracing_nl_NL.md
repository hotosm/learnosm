...
+  Het meest eenvoudige gebruik is om in staat te zijn de bewoonbare gebieden te zien in hogere zoomniveau's bij het bekijken van [OpenStreetMap.org](https://www.openstreetmap.org), waar zij vaalgrijs zijn gekleurd in de standaard weergave.
