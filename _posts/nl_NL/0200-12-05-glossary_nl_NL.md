...
**Slippy Map** : Wat je ziet op <https://www.openstreetmap.org>  bestaat uit een laag en een   software library die zorgt voor de interactive features als zooming & panning.
