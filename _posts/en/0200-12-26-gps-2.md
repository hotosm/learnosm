...
![]({{site.baseurl}}/images/en/eterx_html_68611f09.jpg)
...
![]({{site.baseurl}}/images/en/eterx_html_m6e3eb36.jpg)

![]({{site.baseurl}}/images/en/eterx_html_4c173ec0.png)

Turn on the Eterex 20
---------------------
...
![]({{site.baseurl}}/images/en/eterx_html_m290adb15.png)

Navigate the Eterex 20
----------------------
...
![]({{site.baseurl}}/images/en/eterx_html_m6c0ee553.png)

![]({{site.baseurl}}/images/en/eterx_html_m5f8f3017.png)

![]({{site.baseurl}}/images/en/eterx_html_m56db43f6.png)

![]({{site.baseurl}}/images/en/eterx_html_50171a5b.jpg)

![]({{site.baseurl}}/images/en/eterx_html_735a441b.jpg)

![]({{site.baseurl}}/images/en/eterx_html_edb3f69.jpg)

![]({{site.baseurl}}/images/en/eterx_html_20a2d529.jpg)

1.  By pressing the joystick, you should be able to enter different
    menus. Let's focus first on “Mark Waypoint” and “Manage Tracks”

![]({{site.baseurl}}/images/en/eterx_html_50171a5b.jpg)

![]({{site.baseurl}}/images/en/eterx_html_5a8bddfa.jpg)

![]({{site.baseurl}}/images/en/eterx_html_735a441b.jpg)

![]({{site.baseurl}}/images/en/eterx_html_m4ddaa7fd.jpg)
...
![]({{site.baseurl}}/images/en/eterx_html_488ab685.jpg)

Save Your Location in Eterx 20
------------------------------
...
-  To save your current location as a waypoint, using the joystick,
    ...
    ![]({{site.baseurl}}/images/en/eterx_html_m74a8b112.jpg)

    ![]({{site.baseurl}}/images/en/eterx_html_m117d5ee5.jpg)
...
Turn on the Track Log in Eterx 20
---------------------------------
...
-  To turn on the track log, use the joystick to open the “Manage
    ...
    ![]({{site.baseurl}}/images/en/eterx_html_m34a71bb9.jpg)

    ![]({{site.baseurl}}/images/en/eterx_html_m4ddaa7fd.jpg)

    ![]({{site.baseurl}}/images/en/eterx_html_m3b05f8c8.jpg)

    ![]({{site.baseurl}}/images/en/eterx_html_63a81871.jpg)

    ![]({{site.baseurl}}/images/en/eterx_html_227e8c80.jpg)
...
Copy Waypoints and Tracks to the Computer from Eterx 20
-------------------------------------------------------
...
- Navigate to the GPX file Waypoint\_XX-MMMM-YY.gpx in the folder GPX
    ...
    ![]({{site.baseurl}}/images/en/eterx_html_m6ed1f590.jpg)

-  Navigate to the GPX file Current.gpx to retrieve your track.

    _Path: Garmin eTrex 20 \> Garmin \> GPX \> Current_
    ![]({{site.baseurl}}/images/en/eterx_html_6d5cc501.jpg)

### Install Eterex Drivers
