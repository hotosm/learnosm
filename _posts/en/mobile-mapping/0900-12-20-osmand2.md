...
**Scale and Zoom** indicates the zoom level the canvass in currently in. The display units can be set to Metric or English (in feet or yards), under *Option\>Settings\>General Settings\>Unit of Measure.*  
...
[note1]: /images/mobile-mapping/osmand2_0081b.png
