...
[tilemill logo]: {{sitebaseurl}}/images/en/map-design/tilemill/tilemill-logo.png
[demo map]: {{sitebaseurl}}/images/en/map-design/tilemill/demo-map.png
[tilemill setup]: {{sitebaseurl}}/images/en/map-design/tilemill/tilemill-setup.png
[start tilemill]: {{sitebaseurl}}/images/en/map-design/tilemill/start-tilemill.png
[sample projects]: {{sitebaseurl}}/images/en/map-design/tilemill/sample-projects.png
[tilemill interface]: {{sitebaseurl}}/images/en/map-design/tilemill/tilemill-interface.png
[hand button]: {{sitebaseurl}}/images/en/map-design/tilemill/tilemill-hand-button.png
[zoom control]: {{sitebaseurl}}/images/en/map-design/tilemill/zoom-control.png
[tilemill layers]: {{sitebaseurl}}/images/en/map-design/tilemill/tilemill-layers.png
[tilemill add layer]: {{sitebaseurl}}/images/en/map-design/tilemill/tilemill-add-layer.png
[zoom to extent]: {{sitebaseurl}}/images/en/map-design/tilemill/zoom-to-extent.png
[georgia basic styling]: {{sitebaseurl}}/images/en/map-design/tilemill/georgia-basic-styling.png
[db connection parameters]: {{sitebaseurl}}/images/en/map-design/tilemill/db-connection-parameters.png
[layer extent]: {{sitebaseurl}}/images/en/map-design/tilemill/layer-extent.png
[josm plugin]: {{sitebaseurl}}/images/en/map-design/tilemill/josm-plugin.png
[edit in josm]: {{sitebaseurl}}/images/en/map-design/tilemill/edit-in-josm.png
[georgia 1]: {{sitebaseurl}}/images/en/map-design/tilemill/georgia01.png
[parentheses]: {{sitebaseurl}}/images/en/map-design/tilemill/tilemill-parentheses.png
[zoom buttons]: {{sitebaseurl}}/images/en/map-design/tilemill/zoom-buttons.png
[one tile]: {{sitebaseurl}}/images/en/map-design/tilemill/one-tile.png
[four tiles]: {{sitebaseurl}}/images/en/map-design/tilemill/four-tiles.png
[zoom five]: {{sitebaseurl}}/images/en/map-design/tilemill/zoom-level-five.png
[zoom three]: {{sitebaseurl}}/images/en/map-design/tilemill/zoom-level-three.png
[sample legend]: {{sitebaseurl}}/images/en/map-design/tilemill/sample-legend.png
[export button]: {{sitebaseurl}}/images/en/map-design/tilemill/export-button.png
[shift and drag]: {{sitebaseurl}}/images/en/map-design/tilemill/shift-and-drag.png
[png dimensions]: {{sitebaseurl}}/images/en/map-design/tilemill/png-dimensions.png
[save png]: {{sitebaseurl}}/images/en/map-design/tilemill/save-png.png
