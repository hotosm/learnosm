...
learn several methods for field surveying in this Beginner Guide.

In this section we will see what a GPS does and how it works. You will
...
[Google Earth software, showing coordinates of Lombok, Indonesia]: {{site.baseurl}}/images/en/en_beg_05_gps_image00_google-earth-lombok.png
[Garmin eTrex Vista HCx]: {{site.baseurl}}/images/en/en_beg_05_gps_image01_garmin-etrex.png
[GPS determined location]: {{site.baseurl}}/images/en/en_beg_05_gps_image02_aquiring-satellites.png
[GPS main menu]: {{site.baseurl}}/images/en/en_beg_05_gps_image03_main.png
[GPS all]: {{site.baseurl}}/images/en/en_beg_05_gps_image04_all.png
[GPS path]: {{site.baseurl}}/images/en/en_beg_05_gps_image05_google-earth.png
[save location 1]: {{site.baseurl}}/images/en/en_beg_05_gps_image06_save-location1.png
[save location 2]: {{site.baseurl}}/images/en/en_beg_05_gps_image07_save-location2.png
[turn on track]: {{site.baseurl}}/images/en/en_beg_05_gps_image08_turn-on-track.png
[GPSBabel Interface]: {{site.baseurl}}/images/en/en_beg_05_gps_image09_babel.png
[Choose GPX XML]: {{site.baseurl}}/images/en/en_beg_05_gps_image10_xml.png
[GPS Files Open in JOSM]: {{site.baseurl}}/images/en/en_beg_05_gps_image11_open-josm.png