...
> OpenStreetMap.org is a collabarative, crowd sourced, free map of the world. Anyone can contribute to OpenStreetMap to map any part of the world that interests them.
...
The role of the Tasking Manager is to present a specific geographic region and devide it up into small mapping areas called "tasks". These can be locked by a mapper to avoid other contributors mapping the same objects and introducing duplicated data or run into conflicts. Once mapping is complete in this small area, the mapper reports back to the Tasking Manager that it is finished. And the mappers can select a new task to continue their contribution to OpenStreetMap.

Experienced mappers are going to check each of the tasks and make sure the quality of the data being introduced in OpenStreetMap is well. Eventually they would mark the task as validated or give it back to the mappers with instructions on how to improve.
...
In case you already have an OpenStreetMap account. Just go to the [Tasking Manager](https://tasks.hotosm.org) and press `Log in`
...
- Waterways: Useful for damage assessments or contract tracing with diseases.
...
This is your main screen for working on a project. The screen is devided into two parts.
...
The right side of the screen is a map showing the tasks (often times as squares) coloured according to their status. Tasks that are available to you can be selected by clicking on them.
...
[TM overview]: /images/coordination/tm4_overview.gif
[TM4-user-guide-1]: /images/coordination/tm4_quickstart_step_1.jpg
[TM4-user-guide-2]: /images/coordination/tm4_quickstart_step_2.jpg
[TM4-user-guide-3]: /images/coordination/tm4_quickstart_step_3.jpg
[TM4-user-guide-4]: /images/coordination/tm4_quickstart_step_4.jpg
