...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image20.png)

The OSM Slippy Map is made of many individual image tiles.

![]({{site.baseurl}}/images/advance/en_adv_ch2_image06.png)
...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image16.png)
...
1. Go to [http://mapbox.com/tilemill/](http://mapbox.com/tilemill/) and
   ...
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image04.png)
...
3. Once TileMill is installed go to your Start Menu and click 
   “Start  TileMill.” 
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image29.png)
...
4. This will load the projects tab of the application. TileMill comes
   ...
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image02.png)
...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image13.png)
...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image28.png)
...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image10.png)
...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image21.png)
...
1. Let’s add a new shapefile layer to the map. Click “Add Layer.”
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image30.png)
...
3. On the layers tab find your new layer and click the “Zoom to extent”
   button.
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image24.png)

4. This will zoom to the new layer. If you selected “Save & Style” it
   will come with some basic styling.
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image19.png)
...
2. Click on the “PostGIS” button.
   ...
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image26.png)
...
6. Click on “Save & Style,” and your new layer should be added to the
   ...
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image31.png)
...
1. Go to the Plugins tab and Install JOSM Editor.
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image01.png)
...
3.  In TileMill, navigate to the area that you want to edit.
    ...
    ![]({{site.baseurl}}/images/advance/en_adv_ch2_image00.png)
...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image15.png)
...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image12.png)
...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image22.png)
...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image08.png)

Zoom Level 1 - Four Tiles 
![]({{site.baseurl}}/images/advance/en_adv_ch2_image17.png)
...
Zoom Level 5
![]({{site.baseurl}}/images/advance/en_adv_ch2_image03.png)
...
1. It is easy to create a legend using HTML with TileMill. Simply click on
   ...
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image23.png)
...
2. On the “Legend” tab you’ll see the HTML code that makes up the legend
   ...
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image14.png)
...
![]({{site.baseurl}}/images/advance/en_adv_ch2_image25.png)
...
5. The image rendering will process and when it’s finished you can save
   ...
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image07.png)
...
3. You will also want to adjust the zoom setting so that your file does
   ...
   ![]({{site.baseurl}}/images/advance/en_adv_ch2_image18.png)
