...
will be something like PostgreSQL 9.1 on 
port 5432. ![]({{site.baseurl}}/images/en_adv_ch1_image01.png)
...
-> PostgreSQL 9.1 -> pgAdmin III. ![]({{site.baseurl}}/images/en_adv_ch1_image16.png)

2. In the panel on the left under Servers, right-click where it says
PostgreSQL and click “Connect.” ![]({{site.baseurl}}/images/en_adv_ch1_image08.png)
...
you can create and access a database. ![]({{site.baseurl}}/images/en_adv_ch1_image37.png)

4. Right-click on Databases and select New 
Database... ![]({{site.baseurl}}/images/en_adv_ch1_image23.png)
...
PostGIS Shapefile and DBF loader 1.5 ![]({{site.baseurl}}/images/en_adv_ch1_image10.png)
...
smoothly, the output will read “Shapefile import completed.” ![]({{site.baseurl}}/images/en_adv_ch1_image17.png)
...
10. Open QGIS and click on the “Add PostGIS Layers” 
button. ![]({{site.baseurl}}/images/en_adv_ch1_image12.png)
...
browser to: [http://wiki.openstreetmap.org/wiki/Osm2pgsql\#Windows](http://wiki.openstreetmap.org/wiki/Osm2pgsql#Windows) ![]({{site.baseurl}}/images/en_adv_ch1_image28.png)
...
5. Click on the button named “Environment Variables.” ![]({{site.baseurl}}/images/en_adv_ch1_image34.png)

6. At the bottom find the variable named “Path” and click 
“Edit...” ![]({{site.baseurl}}/images/en_adv_ch1_image38.png)

7. Now you must add the directory where osm2pgsql.exe is located to the
Path variable. ![]({{site.baseurl}}/images/en_adv_ch1_image22.png)
...
10. Open QGIS and go to Plugins -> 
Fetch Python Plugins... ![]({{site.baseurl}}/images/en_adv_ch1_image14.png)

11. We need to add a new plugin repository. Click the “Repositories”
tab.
...
“[http://qgis.dbsgeo.com](http://qgis.dbsgeo.com)” ![]({{site.baseurl}}/images/en_adv_ch1_image03.png)
...
named “OSM Tools.” ![]({{site.baseurl}}/images/en_adv_ch1_image40.png)
...
tables.![]({{site.baseurl}}/images/en_adv_ch1_image25.png)
