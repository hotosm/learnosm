...
-   Be sure that your computer is on and you are connected to the
    internet.
1.   To visit the OpenStreetMap website, you need to open your web
    browser. Start your browser – Firefox, Chrome, Opera, or Internet
    Explorer.
2   In the address bar at the top of the window, enter the following
    text: [www.openstreetmap.org](www.openstreetmap.org)
3.  When the page has finished loading, you should see something like
    this:
