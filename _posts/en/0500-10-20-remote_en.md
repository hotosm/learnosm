...
You may also like to view the short video's provided by [MapGive](http://mapgive.state.gov/learn-to-map/) - please be aware the Tasking Manager has been upgraded since the video was made - the principles are the same but the colours have altered.
...
-  You know what the Tasking Manager does, and have an idea about how you will use it, and  
