...
Click [here to download Mapathon.odt](files/Mapathon.odt) and [here to download Mapathon.pdf](files/Mapathon.pdf)
...
2.  To map this building, create a rectangular extending from the arrows of point 2, to where you estimate the building ends, indicated by point 3 in this image.
