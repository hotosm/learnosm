...
[conflict detected]: {{sitebaseurl}}/images/editing/conflict-resolution/conflict-detected.png
[resolved automatically]: {{sitebaseurl}}/images/editing/conflict-resolution/resolved-automatically.png
[warning unresolved]: {{sitebaseurl}}/images/editing/conflict-resolution/warning-unresolved.png
[check on server]: {{sitebaseurl}}/images/editing/conflict-resolution/check-on-server.png
[still in use]: {{sitebaseurl}}/images/editing/conflict-resolution/still-in-use.png
[synchronize node]: {{sitebaseurl}}/images/editing/conflict-resolution/synchronize-node.png
[properties with conflicts]: {{sitebaseurl}}/images/editing/conflict-resolution/properties-with-conflicts.png
[conflicts resolved]: {{sitebaseurl}}/images/editing/conflict-resolution/conflicts-resolved.png
[synchronize node]: {{sitebaseurl}}/images/editing/conflict-resolution/synchronize-node.png
[command stack]: {{sitebaseurl}}/images/editing/conflict-resolution/command-stack.png
[one unresolved]: {{sitebaseurl}}/images/editing/conflict-resolution/one-unresolved.png
[edit outside area]: {{sitebaseurl}}/images/editing/conflict-resolution/edit-outside-area.png
