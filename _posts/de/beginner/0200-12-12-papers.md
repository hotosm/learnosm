...
-   Sie sehen jetzt, dass Ihr Ausdruck aufbereitet wird. Sobald er fertig ist, sehen Sie die Seiteneinteilung
    Ihres Field Paper auf dieser Seite. Es dauert meist nur wenige Minuten, hängt aber davon ab, aus wievielen
...
-   Sobald das Walking Paper gescannt und auf dem Computer gespeichert 
	ist, können Sie den Browser öffnen und wie vorhin zu fieldpapers.org 
	zurückkehren. 
...
>   wir auch Satellitenbilder als Hintergrund verwenden können.
...
-   Jetzt können Sie das Field Papern in JOSM laden und als 
