...
<!--- From this marker to the next is not visible on the site and is only included to make the later translation easier - this is the text from the old, now deleted, start-id, file.  
...
From the end of this line onwards will now be visible on the site and the following text is to be translated --->
