...
چندین عامل بر موفقیت رویداد لندن اثر داشته است اما عمدتاً استراتژی زیر ...
...
14. در مورد یک محل عمومی یا هر مکان دیگر برای دیدارهای آتی تصمیم بگیرید و بررسی کنید که حتماً در Openstreetmap باشد.

### در کارزار
1. زود به محل بروید و مطمئن شوید که پذیرش کاملاً چیده شده و برای رویداد آماده است.  
...
4. همراه با شخص مقیم IT بررسی کنید که اتصال اینترنت کاملاً کار می‌کند و صفحه نمایش به لپ‌تاپ مربوطه متصل است.
