...
می‌توانید آخرین زمان به‌روزرسانی داده را بررسی کنید. لطفاً توجه داشته باشید که سرور معمولاً داده‌ها را هر ۲۴ ساعت به‌روز می‌کند، بنابراین اگر شما به تازگی داده‌ای را به OSM آپلود کرده‌اید، آن داده به طور خودکار هنگام دانلود نمایش داده نمی‌شود، و بایست منتظر آخرین به‌روزرسانی سرور بمانید.  
...
### دیجیتالی کردن 
روش سوم و چهارم انتخاب AOI در ابزار صادرات، با کشیدن یک کادر محدوده با انتخاب گزینه 'کادر' (Box) از ستون ابزار سمت راست صفحه و یا با انتخاب ابزار 'کشیدن' (Draw)، و رسم آزادانه یک چندضلعی مستقیماً روی نقشه، انجام می‌شود.
