...
<!--- This was copied and pasted from the now deleted 'start id' file - this may make it easier for you to translate the information in this file.  
...
Everything below this comment needs translating --->
