...
<!--- From this marker the text is not visible and is included only to make the later translation easier - this is the text from the old, now deleted, start-id section  
...
From the end of this line onwards will be visible, and is the text to be translated --->
