---
layout: doc
title: Редагування зібраних даних
permalink: /uk/beginner/editing-with-josm/
lang: uk
category: beginner
---

Редагування зібраних даних
=========================
Ви тепер знаєте про всі будівельні блоки, з яких складається процес створення
мапи в OpenStreetMap. Ви навчились, як використовувати GPS та Обхідні листи
...
листи (Field Papers) — все, що показується у вікні мапи JOSM.
...
працюємо. "Field Papers” — шар, створений під час додавання Обхідних листів  
(Field Paper) в JOSM.
...
Референсні шари, такі як супутникові знімки, треки GPS, Обхідні листи (Field Papers) часто називають “базовими”. Шар з даними OSM — шар даних з якими ви насправді працюєте.
...
-   Ви можете вилучити шар, виділивши його та використавши кнопку для вилучення:
...
-   Нарешті, дуже важливо знати, що ви можете вносити зміни тільки до шару який
    ...
    шарів, такі як: точки GPS, Walking Papers та супутникові знімки, не можуть
    бути зміненими. Редагувати можна тільки шар з даними з OpenStreetMap, який
    типово зветься “Data Layer 1”.
...
Використання даних GPS та Обхідних листів (Field Papers)
--------------------------------------------------------
В попередніх розділах ви навчились, як збирати дані за допомогою GPS та
Обхідних листів (Field Papers), та як завантажувати їх в шари JOSM.
...
можете використовувати ваші дані GPS, Обхідні листи (Field Papers), нотатки, чи
...
на панелі Теґи/Членство (Properties) праворуч.
...
### Поширена помилка: Позначення точок, коли ви бажаєте призначити теґи лініями чи полігонам
...
завантажувати дані кожного разу, коли ви збираєтесь щось змінити, на випадок,
якщо хтось інший вже додав зміни на цій ділянці.
...
постійного зв’язку з інтернетом, ви можете завантажувати та зберігати дані
...
*  [Навчання після засвоєння Курівництва для новачків](/uk/beginner/moving-forward/)
