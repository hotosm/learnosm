...
<!--- This section is not visible on the site & contains a copy of the information that was in the, now deleted, start-id file. Pasted here in case it makes the translating of the following text any easier.  
...
From the end of this line onwards will be visible, and is the text that needs translation. --->
