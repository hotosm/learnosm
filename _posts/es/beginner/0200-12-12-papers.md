...
layout: doc
title: Field Papers
permalink: /es/beginner/field-papers/
lang: es
category: beginner
---


Relevamiento con lo *Field Papers*
==================================
...
añadir los datos a OpenStreetMap. Puedes ver un video de 8 minutos
[Tutorial Field Papers video](http://www.youtube.com/watch?v=A_HGkBXZ69g&feature=youtu.be)
sobre cómo crear un mapa y subir la imágen.
...
-   Abre el navegador. En la barra de las direcciones teclea lo siguiente y pulsa
	Intro: [fieldpapers.org](http://fieldpapers.org/)
...
- La siguiente opción te permite seleccionar el tipo de datos que
	...
	ve. Por ahora, vamos a seleccionar **Black and White**.
...
- La siguiente opción te permite seleccionar un diseño. Hay tres
...
>   Los complementos agregar funcionalidad adicional a JOSM. El
