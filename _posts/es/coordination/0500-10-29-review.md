...
Notese que en los shapefiles los nombres de columna están truncados, ya que estos están limitados a 10 carácteres.
...
- Estos edificios pueden ser examinados para identificar qué atributos faltan y si es necesario realizar de nuevo el trabajo. Es posible hacer un mapa con QGIS para entregrar al equipo que vaya a volver a campo y que muestre a qué edificios les faltan atributos.
