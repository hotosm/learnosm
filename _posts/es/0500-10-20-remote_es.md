...
-  [Sección Administrador de Tareas de LearnOSM](/en/coordination/tm-user/). Necesitarás conocer como ingresar al Administrador de Tareas, encontrar un proyecto particular, seleccionar un cuadrado, y que hacer con él. Necesitas leer todo el capítulo!  
