...
permalink: /jp/coordination/remote/
lang: jp
...
1.  The boundary needs to be contiguous, so that the start point of the line (way) around a village, joins to the end point.  
2.  The boundary should not join to highways, waterways, buildings, or any other feature.  
...
This sometimes takes place, but often the situation is a little more confusing. In the screenshot above my square contains part of a landuse=residential boundary. The person who completed the square to my right has continued a landuse=residential boundary through their square, and has then correctly 'handed it over' to me by placing the boundary just within my square for me to establish exactly where it should be in my square.  
